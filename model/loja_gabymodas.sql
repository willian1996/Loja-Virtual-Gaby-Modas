...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 09-Jul-2019 às 20:13
...
CREATE TABLE IF NOT EXISTS `produtos` (
  ...
  `pro_frete_gratis` varchar(100) NOT NULL,
  PRIMARY KEY (`pro_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
(1, 1, 'Camisa Social', 'Esta é uma camisa social manga longa', 15.3, 80, 80, 80, 80, 'aaaaaa', 'camisa', 1, 'modelo01', 'ref 01', 1, '1', 'gratuito');
COMMIT;
